  ...
  return (
    <>
      ...
      <div className="center">
        ...
        <p><h1>Ramakrishna Mission, Rourkela </h1></p>

        <p>The Ramakrishna Mission, Rourkela, is located in the heart of the tribal-dominated Sundargarh district in Odisha. Founded by dedicated devotees of Sri Ramakrishna in 1978, the Temple was inaugurated by the revered Srimat Swami Vireswaranandaji Maharaj 10th President of Ramakrishna order in the year 1980 and has since been blessed by many senior monks of the holy order.</p>
        ...
        <p>To address these issues, we urgently need to construct essential facilities, including Monks’ Quarters, an Office, a Book Sale Counter, an Art Gallery, and a smart classroom for value education. Our plans include setting up a School of E-learning for Tribal and Unemployed Youth.</p>
        <p>The Temple requires significant repairs to meet the standards of our other Temples in India, which need huge funds.</p>
