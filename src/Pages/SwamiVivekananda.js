      ...
      <div className="split">
        <div>
          ...
          <div className="content">
            ...
            <div ref={acc}>
              <button className="accordian"><i className="fa-solid fa-angle-up"></i>With Sri Ramakrishna</button>
              <div class="panel">
              ...
              <button className="accordian"><i className="fa-solid fa-angle-up"></i>Difficult Situations</button>
              <div class="panel">
              ...
              <button className="accordian"><i className="fa-solid fa-angle-up"></i>Beginnings of a Monastic Brotherhood</button>
              <div class="panel">
              ...
              <button className="accordian"><i className="fa-solid fa-angle-up"></i>Awareness of Life’s Mission</button>
              <div class="panel">
              ...
              <button className="accordian"><i className="fa-solid fa-angle-up"></i>Discovery of Real India</button>
              <div class="panel">
              ...
              <button className="accordian"><i className="fa-solid fa-angle-up"></i>Need for an Organization</button>
              <div class="panel">
              ...
              <button className="accordian"><i className="fa-solid fa-angle-up"></i>Decision to attend the Parliament of Religions</button>
              <div class="panel">
              ...
              <button className="accordian"><i className="fa-solid fa-angle-up"></i>The Parliament of Religions and After</button>
              <div class="panel">
              ...
              <button className="accordian"><i className="fa-solid fa-angle-up"></i>Awakening His Countrymen</button>
              <div class="panel">
              ...
              <button className="accordian"><i className="fa-solid fa-angle-up"></i>Founding of Ramakrishna Mission</button>
              <div class="panel">
              ...
              <button className="accordian"><i className="fa-solid fa-angle-up"></i>Belur Math</button>
              <div class="panel">
              ...
              <button className="accordian"><i className="fa-solid fa-angle-up"></i>Disciples</button>
              <div class="panel">
