      ...
      <div className="split">
        <div>
          ...
          <div className="content-2">
            ...
            <div ref={acc}>
              <button className="accordian"><i className="fa-solid fa-angle-up"></i>Marriage</button>
              <div class="panel">
              ...
              <button className="accordian"><i className="fa-solid fa-angle-up"></i>Visit to Dakshineshwar</button>
              <div class="panel">
              ...
              <button className="accordian"><i className="fa-solid fa-angle-up"></i>Life at Dakshineshwar</button>
              <div class="panel">
              ...
              <button className="accordian"><i className="fa-solid fa-angle-up"></i>Worshipped by Sri Ramakrishna</button>
              <div class="panel">
              ...
              <button className="accordian"><i className="fa-solid fa-angle-up"></i>Leading the Sangha after the Master’s Passing</button>
              <div class="panel">
              ...
              <button className="accordian"><i className="fa-solid fa-angle-up"></i>Simplicity and Forbearance</button>
              <div class="panel">
              ...
              <button className="accordian"><i className="fa-solid fa-angle-up"></i>Mother of All</button>
              <div class="panel">
              ...
              <button className="accordian"><i className="fa-solid fa-angle-up"></i>Ideal Woman</button>
              <div class="panel">
