      ...
      <div className="split">
        <div>
          ...
          <div>
            ...
            <div ref={acc}>
              <button className="accordian">Early Days</button>
              <div class="panel">
              ...
              <button className="accordian">As a Priest at Dakshineswar Temple</button>
              <div class="panel">
              ...
              <button className="accordian">Intense spiritual practices</button>
              <div class="panel">
              ...
              <button className="accordian">Following other faiths</button>
              <div class="panel">
              ...
              <button className="accordian">Worshipping his wife</button>
              <div class="panel">
              ...
              <button className="accordian">Contact with some notables</button>
              <div class="panel">
              ...
              <button className="accordian">Coming of the devotees</button>
              <div class="panel">
              ...
              <button className="accordian">The Gospel of Sri Ramakrishna</button>
              <div class="panel">
