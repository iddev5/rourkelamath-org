      ...
      <Header Sidebar={Sidebar} SetSidebar={SetSidebar} />
        ...
        <div className="center">
          ...
          <div className="content">
            ...
            <div ref={acc}>
              <button className="accordian">What Does It Mean To “Join The Ramakrishna Order”?<i className="fa-solid fa-angle-up"></i></button>
              <div class="panel">
              ...
              <button className="accordian">What Are The Essential Conditions For Becoming A Monk In The Ramakrishna Order?<i className="fa-solid fa-angle-up"></i></button>
              <div class="panel">
              ...
              <button className="accordian">What Are The Options For Young Women Who Are Interested In Embracing Monastic Life?<i className="fa-solid fa-angle-up"></i></button>
              <div class="panel">
              ...
              <button className="accordian">I’m Married. Can I Join The Ramakrishna Order?<i className="fa-solid fa-angle-up"></i></button>
              <div class="panel">
              ...
              <button className="accordian">I’m A College/University Student. Can I Join The Order Now?<i className="fa-solid fa-angle-up"></i></button>
              <div class="panel">
              ...
              <button className="accordian">Why Is Academic Qualification Insisted Upon For A Man Who Wants To Renounce Everything?<i className="fa-solid fa-angle-up"></i></button>
              <div class="panel">
              ...
              <button className="accordian">I’ve Some Health Issue. Will That Be An Obstacle To My Joining The Order?<i className="fa-solid fa-angle-up"></i></button>
              <div class="panel">
              ...
              <button className="accordian">Can I Pursue My College Or Higher Studies After Joining The Order?<i className="fa-solid fa-angle-up"></i></button>
              <div class="panel">
                <p>Candidates, in general, are expected to have finished their formal education before entering the monastery.</p>
              </div>
              <button className="accordian">I’ve Not Read Books On Sri Ramakrishna Or Swami Vivekananda. Can I Join The Order?<i className="fa-solid fa-angle-up"></i></button>
              <div class="panel">
              ...
              <button className="accordian">I’m Not A Hindu By Birth. Can I Join The Order?<i className="fa-solid fa-angle-up"></i></button>
              <div class="panel">
              ...
              <button className="accordian">I’m A Devotee Of Krishna (Or Shiva, Kali, Christ Or Any Other Deity). Can I Join The Order?<i className="fa-solid fa-angle-up"></i></button>
              <div class="panel">
              ...
              <button className="accordian">I Want To Serve My Country, Especially The Poor And The Helpless. Can I Join The Order?<i className="fa-solid fa-angle-up"></i></button>
              <div class="panel">
              ...
              <button className="accordian">I’ve Led Rather A Morally Impure Life. Am I Eligible To Join The Order?<i className="fa-solid fa-angle-up"></i></button>
              <div class="panel">
              ...
              <button className="accordian">I Want To Become A Monk. But My Parents Are Against It. What Should I Do? (OR) I Am The Only Son Of My Parents. Who Will Look After Them If I Become A Monk?<i className="fa-solid fa-angle-up"></i></button>
              <div class="panel">
              ...
              <button className="accordian">I’ve Some Property In My Name. What Will Happen To It If I Join?<i className="fa-solid fa-angle-up"></i></button>
              <div class="panel">
              ...
              <button className="accordian">Can I Remain In Touch With My Parents And Relatives After Joining?<i className="fa-solid fa-angle-up"></i></button>
              <div class="panel">
              ...
              <button className="accordian">Will I Be Paid Salary In The Order?<i className="fa-solid fa-angle-up"></i></button>
              <div class="panel">
              ...
              <button className="accordian">If I Join The Order, Who Will Take Care Of My Personal Needs? Who Will Look After Me When I Become Old?<i className="fa-solid fa-angle-up"></i></button>
              <div class="panel">
                <p>The Order will take care of you and support you in every way. There is no need to worry on that account.</p>
              </div>
              <button className="accordian">How Should I Dress After Joining The Order?<i className="fa-solid fa-angle-up"></i></button>
              <div class="panel">
              ...
              <button className="accordian">If I Join Tomorrow, How Long Will It Take To Become A Monk In The Full Sense Of The Term?<i className="fa-solid fa-angle-up"></i></button>
              <div class="panel">
              ...
              <button className="accordian">What Am I Expected To Do After Joining The Order?<i className="fa-solid fa-angle-up"></i></button>
              <div class="panel">
              ...
              <button className="accordian">Are There Any Spiritual Teachers (Gurus) Who Can Help Me?<i className="fa-solid fa-angle-up"></i></button>
              <div class="panel">
              ...
              <button className="accordian">I’m Interested In Pranayama Or Raja Yoga. Can I Learn And Practise Them In The Order?<i className="fa-solid fa-angle-up"></i></button>
              <div class="panel">
              ...
              <button className="accordian">I’m Interested In Studying Vedanta In Depth. Can I Do That After Joining The Order?<i className="fa-solid fa-angle-up"></i></button>
              <div class="panel">
              ...
              <button className="accordian">Can I Join At Any Branch Of The Order?<i className="fa-solid fa-angle-up"></i></button>
              <div class="panel">
              ...
              <button className="accordian">Can I Join At Belur Math?<i className="fa-solid fa-angle-up"></i></button>
              <div class="panel">
              ...
              <button className="accordian">There Is A Ramakrishna Ashrama In My Neighbourhood. Can I Join There?<i className="fa-solid fa-angle-up"></i></button>
              <div class="panel">
              ...
              <button className="accordian">I Like One Particular Branch Of Yours. Can I Spend The Rest Of My Life There As A Monk?<i className="fa-solid fa-angle-up"></i></button>
              <div class="panel">
              ...
              <button className="accordian">Will I Be Posted In Foreign Countries?<i className="fa-solid fa-angle-up"></i></button>
              <div class="panel">
              ...
              <button className="accordian">Suppose I’m Unable To Continue In The Order, Can I Quit?<i className="fa-solid fa-angle-up"></i></button>
              <div class="panel">
              ...
              <button className="accordian">Fine. My Questions Are All Answered. But I’m Still Not Sure Whether To Join The Order Or Get Married. Can You Help Me?<i className="fa-solid fa-angle-up"></i></button>
              <div class="panel">
